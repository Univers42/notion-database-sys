...
// Pure formula-function catalog data, split out of catalog.tsx so non-UI code
// (the "=" sugar desugarer) can reuse the SAME function list the graphical
// editor renders — one source of truth, no JSX, importable from anywhere.
