...
export function StatIconBadge({ color, children }: { color: string; children: React.ReactNode }) {
...
export function EmptyWidget({ title, message }: { title: string; message: string }) {
  return (
