...
/** Renders a to-do list item block with checkbox and editable content. */
  ...
  return (
    <div className={cn("flex items-start gap-2 pl-1")}>
      <button
        ...
        className={cn(`shrink-0 mt-[3px] w-4 h-4 rounded border transition-colors ${
          block.checked
      ...
      >
        {block.checked && (
          <svg className={cn("w-4 h-4")} viewBox="0 0 16 16" fill="none">
      ...
      <EditableContent
        ...
        className={cn(`text-sm leading-relaxed py-0.5 flex-1 ${
