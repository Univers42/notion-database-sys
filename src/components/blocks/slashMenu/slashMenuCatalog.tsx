...
export const SLASH_ITEMS: SlashMenuItem[] = [
  ...
  },
  {
    ...
    icon: <span>✅</span>,
    section: "basic",
    keywords: ["callout", "success", "done", "positive"],
    calloutIcon: "✅",
  },
  {
    type: "callout",
    ...
    icon: <span>❌</span>,
    section: "basic",
    keywords: ["callout", "error", "danger", "failure"],
    calloutIcon: "❌",
  },
  {
    type: "callout",
    ...
    icon: <span>❗</span>,
    section: "basic",
    keywords: ["callout", "important", "priority", "key"],
    calloutIcon: "❗",
  },
  {
    type: "callout",
    ...
    icon: <span>⚠️</span>,
    section: "basic",
    keywords: ["callout", "warning", "caution", "risk"],
    calloutIcon: "⚠️",
  },
  {
    type: "quote",
  ...
  },
  {
    ...
    icon: <IconBookmark />,
    section: "media",
    keywords: ["bookmark", "link", "embed", "web"],
  },
  {
    type: "embed",
    label: "Embed",
    icon: <IconEmbed />,
    section: "media",
    keywords: ["embed", "iframe", "youtube", "figma", "vimeo", "video"],
  },
  ...
  // ── Layout
  {
    ...
    icon: <IconColumns />,
    section: "layout",
    keywords: ["column", "columns", "layout", "side", "split", "grid"],
  },
  {
    type: "spacer",
    label: "Spacer",
  ...
  // ── Advanced
  {
    ...
    icon: <IconTOC />,
    section: "advanced",
    keywords: ["toc", "table of contents", "contents", "outline", "navigation"],
  },
  {
    type: "equation",
    label: "Equation",
  ...
  // ── Database
  {
    ...
    icon: <IconTable />,
    section: "database",
    keywords: ["database", "inline", "table", "spreadsheet", "data"],
  },
  {
    ...
    icon: <IconBoard />,
    section: "database",
    keywords: ["database", "full", "page", "standalone"],
  },
];
