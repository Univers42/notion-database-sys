...
const PARAM_ROUTES: Array<{
  ...
  {
    method: "PATCH",
    pattern: /^\/api\/dbms\/pages\/([^/]+)$/,
    handler: handlePatchPage,
  },
  {
    method: "DELETE",
    pattern: /^\/api\/dbms\/records\/([^/]+)$/,
    handler: handleDeleteRecord,
  },
  {
    method: "DELETE",
    pattern: /^\/api\/dbms\/columns\/([^/]+)\/([^/]+)$/,
    handler: handleDeleteColumn,
  },
  {
    method: "PATCH",
    pattern: /^\/api\/dbms\/columns\/([^/]+)\/([^/]+)\/type$/,
    handler: handleChangeColumnType,
  },
  {
    method: "PUT",
    pattern: /^\/api\/dbms\/databases\/([^/]+)$/,
    handler: handlePutDatabase,
  },
  {
    method: "PUT",
    pattern: /^\/api\/dbms\/views\/([^/]+)$/,
    handler: handlePutView,
  },
  {
    method: "DELETE",
    pattern: /^\/api\/dbms\/views\/([^/]+)$/,
