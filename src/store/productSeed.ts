...
const CATEGORY_OPTIONS: SelectOption[] = [
  { id: 'pcat-elec',   value: 'Electronics',       color: 'bg-blue-100 text-blue-800' },
  { id: 'pcat-cloth',  value: 'Clothing',           color: 'bg-pink-100 text-pink-800' },
  { id: 'pcat-home',   value: 'Home & Kitchen',     color: 'bg-amber-100 text-amber-800' },
  { id: 'pcat-book',   value: 'Books & Media',      color: 'bg-indigo-100 text-indigo-800' },
  { id: 'pcat-sport',  value: 'Sports & Outdoors',  color: 'bg-green-100 text-green-800' },
  { id: 'pcat-beauty', value: 'Health & Beauty',     color: 'bg-rose-100 text-rose-800' },
  { id: 'pcat-food',   value: 'Food & Grocery',     color: 'bg-orange-100 text-orange-800' },
  { id: 'pcat-toys',   value: 'Toys & Games',       color: 'bg-purple-100 text-purple-800' },
  { id: 'pcat-tools',  value: 'Tools & Hardware',   color: 'bg-gray-200 text-gray-800' },
  { id: 'pcat-garden', value: 'Garden & Outdoor',   color: 'bg-emerald-100 text-emerald-800' },
];

const TAG_OPTIONS: SelectOption[] = [
  { id: 'ptag-prem',   value: 'Premium',     color: 'bg-yellow-100 text-yellow-800' },
  { id: 'ptag-org',    value: 'Organic',      color: 'bg-green-100 text-green-800' },
  { id: 'ptag-ltd',    value: 'Limited',      color: 'bg-red-100 text-red-800' },
  { id: 'ptag-best',   value: 'Bestseller',   color: 'bg-blue-100 text-blue-800' },
  { id: 'ptag-clear',  value: 'Clearance',    color: 'bg-gray-200 text-gray-700' },
  { id: 'ptag-new',    value: 'New Arrival',  color: 'bg-cyan-100 text-cyan-800' },
  { id: 'ptag-eco',    value: 'Eco-Friendly', color: 'bg-teal-100 text-teal-800' },
  { id: 'ptag-hand',   value: 'Handmade',     color: 'bg-violet-100 text-violet-800' },
];

const STOCK_OPTIONS: SelectOption[] = [
  { id: 'pstk-in',   value: 'In Stock',      color: 'bg-green-200 text-green-800' },
  { id: 'pstk-low',  value: 'Low Stock',     color: 'bg-yellow-200 text-yellow-800' },
  { id: 'pstk-out',  value: 'Out of Stock',  color: 'bg-red-200 text-red-800' },
  { id: 'pstk-disc', value: 'Discontinued',  color: 'bg-gray-300 text-gray-700' },
  { id: 'pstk-pre',  value: 'Pre-order',     color: 'bg-blue-200 text-blue-800' },
];

const CONDITION_OPTIONS: SelectOption[] = [
  { id: 'pcnd-new',   value: 'New',          color: 'bg-green-100 text-green-700' },
  { id: 'pcnd-ref',   value: 'Refurbished',  color: 'bg-blue-100 text-blue-700' },
  { id: 'pcnd-used',  value: 'Used',         color: 'bg-amber-100 text-amber-700' },
  { id: 'pcnd-open',  value: 'Open Box',     color: 'bg-orange-100 text-orange-700' },
];

const RATING_OPTIONS: SelectOption[] = [
  { id: 'prt-5', value: '★★★★★ (5.0)', color: 'bg-yellow-100 text-yellow-800' },
  { id: 'prt-4', value: '★★★★☆ (4.0)', color: 'bg-yellow-50 text-yellow-700' },
  { id: 'prt-3', value: '★★★☆☆ (3.0)', color: 'bg-orange-50 text-orange-700' },
  { id: 'prt-2', value: '★★☆☆☆ (2.0)', color: 'bg-red-50 text-red-700' },
  { id: 'prt-1', value: '★☆☆☆☆ (1.0)', color: 'bg-red-100 text-red-800' },
];

const SHIPPING_OPTIONS: SelectOption[] = [
  { id: 'pship-free',  value: 'Free Shipping',   color: 'bg-green-100 text-green-700' },
  { id: 'pship-std',   value: 'Standard',        color: 'bg-gray-100 text-gray-700' },
  { id: 'pship-exp',   value: 'Express',         color: 'bg-blue-100 text-blue-700' },
  { id: 'pship-ovn',   value: 'Overnight',       color: 'bg-purple-100 text-purple-700' },
  { id: 'pship-pick',  value: 'Store Pickup',    color: 'bg-amber-100 text-amber-700' },
];

const BRAND_TAG_OPTIONS: SelectOption[] = [
  { id: 'pbrd-lux',   value: 'Luxury',       color: 'bg-amber-100 text-amber-800' },
  { id: 'pbrd-bud',   value: 'Budget',       color: 'bg-green-100 text-green-800' },
  { id: 'pbrd-mid',   value: 'Mid-Range',    color: 'bg-blue-100 text-blue-800' },
  { id: 'pbrd-des',   value: 'Designer',     color: 'bg-pink-100 text-pink-800' },
  { id: 'pbrd-gen',   value: 'Generic',      color: 'bg-gray-100 text-gray-700' },
  { id: 'pbrd-ind',   value: 'Independent',  color: 'bg-violet-100 text-violet-800' },
];
...
export const productDatabase: DatabaseSchema = {
  ...
  properties: {
    ...
    'pp-stock':        {
      ...
      statusGroups: [
        { id: 'psg-avail',   label: 'Available',   color: 'bg-green-200 text-green-800',  optionIds: ['pstk-in', 'pstk-low'] },
        { id: 'psg-limited', label: 'Limited',      color: 'bg-yellow-200 text-yellow-800', optionIds: ['pstk-pre'] },
        { id: 'psg-gone',    label: 'Unavailable',  color: 'bg-red-200 text-red-800',      optionIds: ['pstk-out', 'pstk-disc'] },
      ],
    },
    // ── date × 2 ──
